    ...
    <v-row justify="center" class="my-15">
      <v-col cols="11" sm="9">
        <borderWrapCard class="mb-13 calculator-card">
          <template #content>
            <titleBlock class="mb-8" :title="$t('swapCalculateTitle', {token1: 'EGT', token2: 'USDT'})" :subtitle="$t('egtExchangeRate', {value: '1 : 1200'})" icon="icon-usdt-black.svg"></titleBlock>
              ...
              <v-col cols="12">
                <v-form ref="form" lazy-validation class="d-flex flex-column justify-center align-center">
                  ...
                  <div class="d-flex flex-column align-center">
                    ...
                    <h2 class="secondary--text">{{ usdtResult || '--'}} {{ $t('piece') }} USDT</h2>
                  </div>
                </v-form>
              </v-col>
            </v-row>
